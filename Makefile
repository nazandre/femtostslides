...
MAIN_FILE_NAME = example
BIBFILE = $(MAIN_FILE_NAME).bib
EXTRA_FILES = $(wildcard *.file.tex) femtostslides.sty
...
all: $(MAIN_FILE_NAME)-compressed.pdf
...
$(MAIN_FILE_NAME)-compressed.pdf: $(MAIN_FILE_NAME).pdf
...
realclean: clean
	rm -f $(MAIN_FILE_NAME).pdf $(MAIN_FILE_NAME)-compressed.pdf
